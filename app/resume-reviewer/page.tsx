...
- Do not be too long.
  ...
  function downloadPdf() {
    ...
    doc.setFontSize(20);
    doc.text("AI Resume Review Report", margin, y);
    ...
    doc.setFont("helvetica", "bold");
    doc.setFontSize(13);
    doc.text("Resume Review", margin, y);
          ...
          <div className="rounded-[2rem] border border-cyan-400/20 bg-black/40 p-5 backdrop-blur-xl">
            <div className="mb-4 flex items-center justify-between gap-3">
              ...
              <button
                ...
                className="rounded-2xl border border-emerald-300/25 bg-emerald-300/10 px-4 py-2 text-sm font-semibold text-emerald-100 transition hover:bg-emerald-300/20 disabled:cursor-not-allowed disabled:opacity-40"
              >
            ...
            <div className="mt-4 rounded-3xl border border-cyan-400/15 bg-white/[0.04] p-4">
              <p className="text-sm leading-7 text-slate-300">
                Tip: After AI generates the review, click the PDF button to
          ...
          <div className="grid gap-5 md:grid-cols-[1fr_auto] md:items-center">
            <div>
              ...
              <p className="mt-2 text-sm leading-7 text-slate-300">
                Use the AI review to improve your resume summary, skills,
                experience bullets, and job application emails.
              </p>
            </div>
